<x-app>
    ...
    <div class="card shadow p-3">
        <form method="POST" action="{{ route('user.store') }}" class="form" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"
                        name="password" required minlength="8" data-parsley-equalto=#password>
                    @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    <label for="avatar" class="form-label">Avatar (MaaxSize 1Mb)</label>
            ...
            <div class="text-end">
                <a class="btn btn-warning" href="{{ route('user.index') }}" href="#" role="button">Cancel</a>
